  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <Input id="name" type="text" placeholder="John Doe" className="rounded-none" {...register("name")} />
      ...
      <div className="flex flex-col gap-1">
        ...
        <Input id="email" type="email" placeholder="m@example.com" className="rounded-none" {...register("email")} />
      ...
      <div className="flex flex-col gap-1">
        ...
        <Input id="confirmPassword" type="password" className="rounded-none" {...register("confirmPassword")} />
