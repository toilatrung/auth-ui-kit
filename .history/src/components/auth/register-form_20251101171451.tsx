// --- Feature Reference: RegisterForm Template ---
// This is a reusable register form layout and validation example using ShadCN UI + Zod + React Hook Form
// All API and navigation logic are removed — this file is for UI + validation reuse only.
